...
public class WorldGenTent extends WorldGenBase {

	@Override
	public int getFrequency() {
		return Settings.worldgenSettings.tentFrequency;
	}

	@Override
	public List<ResourceLocation> getBiomeWhitelist() {
		return TracesOfTheFallen.settings.tentBiomeWhitelist;
	}

	@Override
	public List<ResourceLocation> getBiomeBlacklist() {
		return TracesOfTheFallen.settings.tentBiomeBlacklist;
	}
	...
	public IBlockState getBlockState(Random random, World world, BlockPos pos) {
		...
		return ModBlocks.tent.getDefaultState().withProperty(BlockTOFT.FACING, facing).withProperty(BlockTOFT.SNOWY, isSnowy);
	}
