...
public class ParticleChill extends Particle {

	public ParticleChill(World worldIn, double x, double y, double z, double motionX, double motionY, double motionZ) {
		super(worldIn, x, y, z, motionX, motionY, motionZ);
		this.motionX = motionX;
		this.motionY = motionY;
		this.motionZ = motionZ;
		this.particleRed = 0.88F + this.rand.nextFloat() * 0.12F;
