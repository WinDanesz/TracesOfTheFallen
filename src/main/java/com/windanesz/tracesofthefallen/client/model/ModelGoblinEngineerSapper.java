...
public class ModelGoblinEngineerSapper extends ModelGoblinBase {
	...
	public ModelGoblinEngineerSapper() {
		textureWidth = 48;
		textureHeight = 48;
		...
		head.cubeList.add(new ModelBox(head, 0, 33, -3.0F, -6.0F, -3.0F, 6, 4, 6, 0.1F, false));
		...
		arm_left.setRotationPoint(3.0F, -17.0F, -0.5F);
		body.addChild(arm_left);
		arm_left.cubeList.add(new ModelBox(arm_left, 0, 12, 0.0F, 0.0F, -1.5F, 3, 8, 3, 0.0F, false));

		arm_right = new ModelRenderer(this);
		arm_right.setRotationPoint(-3.0F, -17.0F, -0.5F);
		body.addChild(arm_right);
		arm_right.cubeList.add(new ModelBox(arm_right, 0, 12, -3.0F, 0.0F, -1.5F, 3, 8, 3, 0.0F, true));
