...
public class ModelGoblinBrute extends ModelGoblinBase {
	...
	public ModelGoblinBrute() {
		...
		arm_left.setRotationPoint(3.0497F, -16.0F, 0.0071F);
		body.addChild(arm_left);
		arm_left.cubeList.add(new ModelBox(arm_left, 0, 12, -0.0497F, -1.0F, -2.0071F, 3, 8, 3, 0.0F, false));

		arm_right = new ModelRenderer(this);
		arm_right.setRotationPoint(-2.9503F, -16.0F, 0.0071F);
		body.addChild(arm_right);
		arm_right.cubeList.add(new ModelBox(arm_right, 0, 12, -3.0497F, -1.0F, -2.0071F, 3, 8, 3, 0.0F, true));
