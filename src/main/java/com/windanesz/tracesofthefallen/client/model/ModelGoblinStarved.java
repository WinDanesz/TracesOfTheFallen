...
public class ModelGoblinStarved extends ModelGoblinBase {
	...
	public ModelGoblinStarved() {
		...
		cube_r1.setRotationPoint(0.0794F, -4.4742F, -0.938F);
		body.addChild(cube_r1);
		setRotationAngle(cube_r1, 0.3927F, 0.0F, 0.0F);
		cube_r1.cubeList.add(new ModelBox(cube_r1, 27, 12, -3.0794F, -5.7442F, -1.0083F, 6, 6, 3, -0.01F, false));

		head = new ModelRenderer(this);
		head.setRotationPoint(0.0F, -10.0F, -2.5F);
		body.addChild(head);
		...
		ear_left_r1.cubeList.add(new ModelBox(ear_left_r1, 19, -5, 0.0F, -1.0F, 0.0F, 0, 4, 5, 0.0F, false));
		...
		ear_right_r1.cubeList.add(new ModelBox(ear_right_r1, 19, -5, 0.0F, -1.0F, 0.0F, 0, 4, 5, 0.0F, true));
		...
		arm_left.setRotationPoint(3.0F, -9.0F, -2.5F);
		body.addChild(arm_left);
		arm_left.cubeList.add(new ModelBox(arm_left, 0, 12, 0.0497F, -1.0F, -1.4929F, 3, 6, 3, 0.0F, false));

		arm_right = new ModelRenderer(this);
		arm_right.setRotationPoint(-3.0F, -9.0F, -2.5F);
		body.addChild(arm_right);
		arm_right.cubeList.add(new ModelBox(arm_right, 0, 12, -3.0497F, -1.0F, -1.4929F, 3, 6, 3, 0.0F, true));
