...
public class ModelFrostlingBite extends ModelBase {
	...
	public ModelFrostlingBite() {
		...
		mask.setRotationPoint(0.0F, -0.9659F, -0.2588F);
		head_upper.addChild(mask);
		mask.cubeList.add(new ModelBox(mask, 35, 48, -4.0F, -2.9341F, -9.7412F, 8, 0, 10, 0.0F, false));

		craneum = new ModelRenderer(this);
		craneum.setRotationPoint(0.0F, -2.8657F, -11.7083F);
		head_upper.addChild(craneum);
		craneum.cubeList.add(new ModelBox(craneum, 0, 0, -6.0F, -1.0588F, 0.1861F, 12, 4, 13, 0.0F, false));

		lower_jaw = new ModelRenderer(this);
		lower_jaw.setRotationPoint(0.0F, -0.8599F, -6.8623F);
		head_upper.addChild(lower_jaw);
		setRotationAngle(lower_jaw, 0.6545F, 0.0F, 0.0F);
		lower_jaw.cubeList.add(new ModelBox(lower_jaw, 26, 17, -6.0F, 0.9355F, -4.6599F, 12, 2, 5, 0.0F, false));

		tusks_r1 = new ModelRenderer(this);
		tusks_r1.setRotationPoint(0.5821F, 2.9429F, -4.6082F);
		...
		setRotationAngle(arm_right, 0.0F, 0.0F, 2.3562F);
		...
		setRotationAngle(arm_left, 0.0F, 0.0F, -2.3562F);
