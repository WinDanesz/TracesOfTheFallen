...
public class BlockTelescope extends BlockDecoration {

	public BlockTelescope(Material material) {
		super(material);
	}
	...
	public boolean onBlockActivated(World worldIn, BlockPos pos, IBlockState state, EntityPlayer playerIn, EnumHand hand,
		...
		EntityTelescopeSeat seat = EntityTelescopeSeat.getOrCreate(worldIn, pos, state);
