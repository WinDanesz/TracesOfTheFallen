...
public class GoblinAIFollowOwner extends EntityAIBase {
	private final EntityGoblin tameable;
	...
	public GoblinAIFollowOwner(EntityGoblin tameableIn, double followSpeedIn, float minDistIn, float maxDistIn) {
